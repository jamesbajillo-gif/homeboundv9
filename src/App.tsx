...
import CampaignMappingPage from "./pages/settings/CampaignMappingPage";
import CampaignDiagnosticsPage from "./pages/settings/CampaignDiagnosticsPage";
import AdminConfigPage from "./pages/settings/AdminConfigPage";
...
const App = () => (
  <QueryClientProvider client={queryClient}>
    <TooltipProvider>
      <Toaster />
      <Sonner />
      <BrowserRouter basename="/ibm_dynamicscript">
        <CampaignProvider>
          <VICIProvider>
            <Routes>
              ...
              <Route path="/settings/campaign-mapping" element={<ProtectedSettingsRoute><CampaignMappingPage /></ProtectedSettingsRoute>} />
              <Route path="/settings/campaign-diagnostics" element={<ProtectedSettingsRoute><CampaignDiagnosticsPage /></ProtectedSettingsRoute>} />
              <Route path="/settings/admin-config" element={<ProtectedSettingsRoute><AdminConfigPage /></ProtectedSettingsRoute>} />
