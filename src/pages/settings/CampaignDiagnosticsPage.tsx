...
import { CampaignDiagnostics } from "@/components/settings/CampaignDiagnostics";
import { SettingsCampaignSelector } from "@/components/settings/SettingsCampaignSelector";

const CampaignDiagnosticsPage = () => {
    ...
    <div className="h-screen flex flex-col bg-background overflow-hidden">
      ...
      <div className="flex-none bg-background border-b p-4 sm:p-6 lg:px-8 lg:py-4">
        <div className="max-w-6xl mx-auto flex items-center gap-4">
          ...
          <h1 className="text-3xl font-bold text-foreground">Campaign Diagnostics</h1>
        </div>
      </div>
...
export default CampaignDiagnosticsPage;
