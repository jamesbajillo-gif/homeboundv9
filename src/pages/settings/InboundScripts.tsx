...
const InboundScripts = () => {
  ...
  const qualificationTitleKey = "tmdebt_qualification_tab_title_inbound";
  ...
  const handleSaveEdit = async (tabKey: string) => {
    if (editTitle.trim()) {
      ...
      if (tabKey === "inbound_qualification") {
    ...
    <div className="h-screen flex flex-col bg-background overflow-hidden">
      ...
      <div className="flex-none bg-background border-b p-4 sm:p-6 lg:px-8 lg:py-4">
        <div className="max-w-6xl mx-auto flex items-center justify-between">
          ...
          <AddTabDialog onAdd={createTab} isCreating={isCreating} groupType="inbound" />
        </div>
      </div>
